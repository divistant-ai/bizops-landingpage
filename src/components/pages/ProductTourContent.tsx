          ...
          <div className="mx-auto grid h-full w-full max-w-6xl grid-cols-12 gap-8">
            ...
            <div className="col-span-9 space-y-8">
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="group cursor-pointer rounded-2xl bg-linear-to-br from-indigo-600 to-violet-700 p-6 text-white shadow-xl transition-all hover:scale-[1.02] hover:shadow-2xl" onClick={onNext}>
                  <div className="mb-4 flex items-start justify-between">
