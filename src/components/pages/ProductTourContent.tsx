...
export default function ProductTourContent() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-slate-50 font-sans text-slate-900 transition-colors duration-500 dark:bg-slate-950 dark:text-white">
      ...
      <Container size="7xl" className="relative z-10 flex min-h-[calc(100vh-5rem)] flex-col py-12 lg:py-20">
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="flex flex-col gap-6 lg:col-span-4">
            <div className="mb-4 hidden lg:block">
              <h3 className="mb-4 px-2 text-sm font-bold tracking-widest text-slate-500 uppercase">{t('select_scenario')}</h3>
              <div className="space-y-3">
                {scenarios.map((sc) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`rounded-xl p-2.5 transition-colors ${isActive ? 'bg-indigo-600 text-white shadow-md' : 'bg-slate-100 text-slate-500 group-hover:text-indigo-600 dark:bg-slate-800 dark:text-slate-400 dark:group-hover:text-white'}`}>
                        <Icon className="h-5 w-5" />
                      </div>
                      <div className="flex-1">
                        <div className={`text-sm font-bold ${isActive ? 'text-slate-900 dark:text-white' : 'text-slate-600 group-hover:text-slate-900 dark:text-slate-300 dark:group-hover:text-white'}`}>
                          {sc.label}
                        </div>
                      ...
                      {isActive && <ChevronRight className="h-5 w-5 animate-pulse text-indigo-600 dark:text-indigo-400" />}
                    </button>
                  );
                })}
              </div>
              ...
              <div className="flex min-w-max gap-3">
                {scenarios.map((sc) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-fit rounded-lg p-2 ${isActive ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-500 dark:bg-slate-800'}`}>
                        <Icon className="h-5 w-5" />
                      </div>
                      <div>
                        <div className={`text-sm font-bold ${isActive ? 'text-slate-900 dark:text-white' : 'text-slate-600 dark:text-slate-300'}`}>
                          {sc.label}
                        </div>
            ...
            <div className="mt-4 hidden rounded-2xl border border-slate-200 bg-white/60 p-6 backdrop-blur-md lg:block dark:border-white/10 dark:bg-white/5">
              <div className={`mb-3 flex items-center gap-2 text-xs font-bold tracking-widest uppercase ${currentScenario.color}`}>
                <span className="h-2 w-2 animate-pulse rounded-full bg-current shadow-[0_0_10px_currentColor]" />
                {t('current_mission')}
              </div>
              <h3 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">{currentScenario.title}</h3>
              <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">{currentScenario.desc}</p>
            </div>
          </div>
          ...
          <div className="relative flex min-h-[650px] flex-col items-center lg:col-span-8">
            ...
            <div className="mb-8 w-full px-4 text-center lg:hidden">
              <h2 className="mb-2 text-2xl font-bold text-slate-900 dark:text-white">{currentScenario.title}</h2>
      ...
      <section className="relative border-t border-slate-200 bg-slate-100/50 py-24 dark:border-white/5 dark:bg-slate-900/50">
        <Container size="7xl">
          <div className="mx-auto mb-16 max-w-3xl text-center">
            <h2 className="mb-4 text-3xl font-bold text-slate-900 lg:text-4xl dark:text-white">{t('benefits_title')}</h2>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:gap-8">
            <div className="group rounded-3xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:border-blue-500/30 hover:shadow-lg dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10">
              ...
              <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">{t('benefits.zero_setup.title')}</h3>
            ...
            <div className="group rounded-3xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:border-purple-500/30 hover:shadow-lg dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10">
              ...
              <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">{t('benefits.realistic.title')}</h3>
              <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
            ...
            <div className="group rounded-3xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:border-emerald-500/30 hover:shadow-lg dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10">
              ...
              <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">{t('benefits.unified.title')}</h3>
              <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
...
const ScenarioContent: React.FC<{
    ...
    return (
      <div className="flex h-full w-full flex-col items-center justify-center bg-slate-50 p-8 text-center dark:bg-slate-900">
        ...
        <div className="flex w-full max-w-xs flex-col gap-3">
          <Button fullWidth size="lg" className="w-full border-none bg-indigo-600 text-white shadow-lg shadow-indigo-500/20 hover:bg-indigo-500" asChild>
            <Link href="/demo">Start Free Trial</Link>
          </Button>
          <button onClick={onReset} className="flex items-center justify-center gap-2 py-3 text-sm text-slate-500 transition-colors hover:text-slate-900 dark:hover:text-white">
      ...
      return (
        <div className="flex h-full flex-col bg-slate-50 font-sans dark:bg-slate-950">
          ...
          <div className="flex-1 space-y-4 overflow-y-auto p-5">
            {/* Sales Target Card */}
            <div className="transform rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-700 p-5 text-white shadow-lg shadow-indigo-900/20 transition-transform duration-300 hover:scale-[1.02]">
              <div className="mb-4 flex items-start justify-between">
                <div>
                  <p className="mb-1 text-xs font-bold tracking-wider text-indigo-100 uppercase opacity-80">{t('sales_target')}</p>
            ...
            <div className="mt-2 flex items-center justify-between px-1">
              <span className="text-xs font-bold tracking-wider text-slate-500 uppercase dark:text-slate-400">{t('recent_drafts')}</span>
              <span className="cursor-pointer text-xs font-bold text-indigo-600 hover:underline dark:text-indigo-400">{t('view_all')}</span>
            </div>

            {/* List Items */}
            {[1, 2].map(i => (
              <div key={i} className="group flex cursor-pointer items-center justify-between rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-indigo-500/50 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-indigo-500/50">
                <div>
                  <h4 className="font-bold text-slate-900 transition-colors group-hover:text-indigo-600 dark:text-white dark:group-hover:text-indigo-500">PT Sumber Makmur</h4>
                ...
                <span className="rounded-md border border-slate-200 bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-500 dark:border-slate-700 dark:bg-slate-800">{t('draft')}</span>
              </div>
            ))}
          </div>
          ...
          <div className="border-t border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
            <Button fullWidth className="h-12 rounded-xl bg-indigo-600 text-base font-bold text-white shadow-lg shadow-indigo-500/30 hover:bg-indigo-500" onClick={onNext}>
        ...
        <div className="flex h-full flex-col bg-slate-50 font-sans dark:bg-slate-950">
          <div className="flex-1 space-y-4 overflow-y-auto p-5">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              <label className="mb-3 block text-xs font-bold tracking-wider text-slate-500 uppercase">{t('customer')}</label>
              <div className="flex items-center justify-between rounded-lg border border-slate-100 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800">
                <span className="text-sm font-bold text-slate-900 dark:text-white">PT Mitra Abadi Teknik</span>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              <div className="mb-3 flex items-center justify-between">
                <label className="text-xs font-bold tracking-wider text-slate-500 uppercase">{t('items')}</label>
                <span className="cursor-pointer text-xs font-bold text-indigo-600 dark:text-indigo-400">+ Add</span>
              </div>
              <div className="mb-2 flex items-center justify-between rounded-lg border border-slate-100 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800">
                <div>
                  <span className="block text-sm font-bold text-slate-900 dark:text-white">MacBook Pro M3</span>
                  <span className="text-xs text-slate-500">5 units</span>
                </div>
                <span className="text-sm font-bold text-slate-900 dark:text-white">Rp 25jt/unit</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-t-3xl border-t border-slate-200 bg-white p-6 shadow-[0_-5px_30px_rgba(0,0,0,0.05)] dark:border-slate-800 dark:bg-slate-900">
            ...
            <Button fullWidth size="lg" className="rounded-xl bg-indigo-600 text-white shadow-lg shadow-indigo-500/20 hover:bg-indigo-500" onClick={onNext}>
              {t('save_and_send')}
            </Button>
          </div>
        </div>
    ...
    if (step === 2) { return (
      <div className="flex h-full flex-col items-center justify-center bg-slate-50 p-6 text-center font-sans dark:bg-slate-950">
        <div className="relative mb-8 flex h-24 w-24 items-center justify-center rounded-3xl border border-slate-100 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="absolute -top-2 -right-2 rounded-full bg-emerald-500 px-2 py-0.5 text-[10px] font-bold text-white shadow-sm">NEW</div>
        </div>
        <h3 className="mb-3 text-2xl font-bold text-slate-900 dark:text-white">{t('quotation_created')}</h3>
        <p className="mx-auto mb-10 max-w-[220px] text-sm leading-relaxed text-slate-500">{t('quotation_ready')}</p>

        <div className="w-full space-y-4">
          <button onClick={onNext} className="group flex w-full items-center justify-center gap-3 rounded-xl bg-[#25D366] py-3.5 font-bold text-white shadow-lg shadow-green-500/20 transition-all hover:bg-[#20bd5a] active:scale-95">
            <Send className="h-5 w-5 transition-transform group-hover:translate-x-1" />
            {' '}
            {t('send_whatsapp')}
          </button>
          <button onClick={onNext} className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white py-3.5 font-bold text-slate-700 transition-colors hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800">
    ...
    if (step === 0) { return (
      <div className="flex h-full flex-col bg-slate-50 font-sans dark:bg-slate-950">
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
          ...
          <span className="rounded-full bg-red-500 px-2 py-0.5 text-xs font-bold text-white shadow-sm">3 Pending</span>
        </div>
        <div className="space-y-4 p-4">
          {/* Active Card */}
          <div className="cursor-pointer rounded-2xl border-l-4 border-indigo-500 bg-white p-5 shadow-sm transition-all hover:shadow-lg active:scale-[0.98] dark:bg-slate-900" onClick={onNext}>
            ...
            <p className="mb-4 text-sm font-medium text-slate-600 dark:text-slate-300">New MacBook for Design Team</p>
            <div className="flex gap-2 text-xs">
              <span className="rounded-md bg-slate-100 px-2.5 py-1 font-medium text-slate-600 dark:bg-slate-800 dark:text-slate-400">IT Dept</span>
              <span className="rounded-md bg-indigo-50 px-2.5 py-1 font-bold text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400">Rp 25.000.000</span>
            </div>
          </div>
          ...
          <div className="rounded-2xl border-l-4 border-slate-200 bg-white p-5 opacity-60 shadow-sm transition-opacity hover:opacity-100 dark:border-slate-800 dark:bg-slate-900">
            <div className="mb-3 flex justify-between">
              <span className="text-sm font-bold text-slate-900 dark:text-white">{t('leave')}</span>
    ...
    if (step === 1) { return (
      <div className="flex h-full flex-col bg-slate-50 font-sans dark:bg-slate-950">
        <div className="z-10 bg-white p-6 shadow-sm dark:bg-slate-900">
          <h4 className="mb-2 text-lg font-bold text-slate-900 dark:text-white">Purchase Request #PR-102</h4>
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-indigo-100 text-xs font-bold text-indigo-600 dark:bg-indigo-900/50 dark:text-indigo-400">JD</div>
            <div>
              <span className="mb-0.5 block text-xs font-bold tracking-wider text-slate-500 uppercase">{t('requested_by')}</span>
        ...
        <div className="flex-1 space-y-6 overflow-y-auto p-6">
          <div className="rounded-2xl border border-indigo-100 bg-indigo-50 p-5 dark:border-indigo-500/20 dark:bg-indigo-900/10">
            <span className="mb-1 block text-xs font-bold tracking-wider text-indigo-500 uppercase">{t('total_amount')}</span>
            <span className="text-3xl font-bold text-indigo-700 dark:text-indigo-400">Rp 25.000.000</span>
          </div>

          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <h5 className="mb-4 border-b border-slate-100 pb-2 text-sm font-bold text-slate-900 dark:border-slate-800 dark:text-white">{t('items')}</h5>
            <div className="flex justify-between py-1 text-sm">
              <span className="font-medium text-slate-700 dark:text-slate-300">MacBook Pro M3 Pro</span>
        ...
        <div className="grid grid-cols-2 gap-4 border-t border-slate-200 bg-white p-5 pb-8 dark:border-slate-800 dark:bg-slate-900">
          <Button variant="outline" className="h-12 rounded-xl border-red-200 text-red-600 hover:border-red-300 hover:bg-red-50 dark:border-red-900/50 dark:text-red-400 dark:hover:bg-red-900/20" onClick={onNext}>{t('reject')}</Button>
          <Button className="h-12 rounded-xl bg-emerald-600 font-bold text-white shadow-lg shadow-emerald-500/20 hover:bg-emerald-500" onClick={onNext}>{t('approve')}</Button>
        </div>
      </div>
    ); }
    if (step === 2) { return <ScenarioContent id="sales" step={3} onNext={onNext} onReset={onReset} />; } // Reuse success
  }
  ...
  if (id === 'finance') {
        ...
        <div className="mx-auto grid h-full w-full max-w-6xl grid-cols-12 gap-8">
          ...
          <div className="col-span-3 flex flex-col gap-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center gap-3 px-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-600 text-white"><DollarSign className="h-5 w-5" /></div>
          ...
          <div className="col-span-9 space-y-8">
            <div className="grid grid-cols-3 gap-6">
              <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <span className="relative z-10 text-xs font-bold tracking-wider text-slate-500 uppercase">{t('cash_on_hand')}</span>
                <div className="relative z-10 mt-2 text-3xl font-extrabold text-slate-900 dark:text-white">Rp 1.25 M</div>
                <span className="relative z-10 mt-2 inline-flex items-center gap-1 rounded-md bg-emerald-50 px-2 py-1 text-xs font-bold text-emerald-500 dark:bg-emerald-900/20">+12% vs last month</span>
                <TrendingUp className="absolute -right-4 -bottom-4 z-0 h-24 w-24 text-slate-50 dark:text-slate-800" />
              </div>

              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <span className="text-xs font-bold tracking-wider text-slate-500 uppercase">{t('payables')}</span>
                <div className="mt-2 text-3xl font-extrabold text-slate-900 dark:text-white">Rp 450 jt</div>
                <span className="mt-2 inline-block text-xs font-bold text-amber-500">Due within 7 days</span>
              </div>

              <div className="group cursor-pointer rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-700 p-6 text-white shadow-xl transition-all hover:scale-[1.02] hover:shadow-2xl" onClick={onNext}>
                <div className="mb-4 flex items-start justify-between">
                  <span className="text-xs font-bold tracking-wider text-indigo-200 uppercase">{t('action_needed')}</span>
                  <div className="rounded-lg bg-white/20 p-1.5 transition-colors group-hover:bg-white/30"><RefreshCw className="animate-spin-slow h-4 w-4" /></div>
                </div>
                <div className="mt-2 mb-1 text-xl font-bold">{t('reconcile_bank')}</div>
                <span className="rounded bg-white/10 px-2 py-1 text-xs text-indigo-100">58 new transactions</span>
              </div>
            </div>
            ...
            <div className="flex h-80 flex-col rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="flex flex-1 items-end justify-between gap-4">
                {[35, 55, 45, 70, 60, 85, 75, 90, 80, 95, 88, 70].map((h, i) => (
                  <div key={i} className="group relative flex h-full w-full items-end overflow-hidden rounded-t-xl bg-slate-100 dark:bg-slate-800">
                    <div className="w-full rounded-t-xl bg-indigo-500 transition-all duration-500 group-hover:bg-indigo-400" style={{ height: `${h}%` }}></div>
                    {/* Tooltip on hover */}
      ...
      <div className="flex h-full items-center justify-center bg-slate-50 p-6 font-sans dark:bg-slate-950">
        <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 bg-white p-10 text-center shadow-2xl dark:border-slate-800 dark:bg-slate-900">
          <div className="absolute top-0 left-0 h-1.5 w-full bg-indigo-100 dark:bg-slate-800">
            <div className="h-full animate-[width_2s_ease-in-out_forwards] bg-indigo-500" onAnimationEnd={onNext} style={{ width: '100%' }}></div>
          </div>
          ...
          <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white">{t('reconciling_status')}</h3>
          <p className="mb-8 text-sm leading-relaxed font-medium text-slate-500">{t('matching_desc')}</p>
    ...
    if (step === 2) { return <ScenarioContent id="sales" step={3} onNext={onNext} onReset={onReset} />; }
  }
  ...
  if (id === 'employee') {
        ...
        <div className="relative z-10 flex h-full flex-col">
          <div className="p-8 pb-4 text-white">
            <div className="mb-8 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/20 text-lg font-bold backdrop-blur-md">BS</div>
                <div>
                  <div className="mb-1 text-xs font-bold tracking-wider uppercase opacity-80">Good Morning</div>
                  <div className="text-xl font-bold">Budi Santoso</div>
                </div>
              </div>
              <div className="cursor-pointer rounded-full bg-white/20 p-2.5 backdrop-blur-md transition-colors hover:bg-white/30"><Clock className="h-6 w-6" /></div>
            </div>
            <div className="mt-6 text-center">
              <div className="mb-2 text-5xl font-extrabold tracking-tight">08:58</div>
              <div className="inline-block rounded-full bg-white/10 px-4 py-1 text-sm font-medium opacity-80">Monday, 12 Oct 2024</div>
            </div>
          </div>

          <div className="-mt-4 mb-8 px-6">
            <div className="group cursor-pointer rounded-3xl border border-slate-100 bg-white p-8 text-center shadow-xl transition-transform duration-300 hover:scale-[1.02] dark:border-slate-800 dark:bg-slate-900" onClick={onNext}>
              ...
              <h3 className="mb-1 text-2xl font-bold text-slate-900 dark:text-white">{t('clock_in')}</h3>
              <p className="text-xs font-bold tracking-wide text-slate-500 uppercase">{t('shift_time')}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 px-6">
            <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white p-5 py-6 shadow-sm transition-colors hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800">
              ...
              <span className="text-sm font-bold text-slate-700 dark:text-slate-300">{t('payslip')}</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white p-5 py-6 shadow-sm transition-colors hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800">
              <Users className="h-8 w-8 text-purple-500" />
              <span className="text-sm font-bold text-slate-700 dark:text-slate-300">{t('leave')}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    if (step === 1) { return (
      <div className="flex h-full flex-col items-center justify-center bg-emerald-500 p-8 text-center font-sans text-white">
        ...
        <Button className="h-14 w-full rounded-xl bg-white text-lg font-bold text-emerald-600 shadow-xl hover:bg-emerald-50" onClick={onNext}>{t('done')}</Button>
      </div>
    ); }
    if (step === 2) { return <ScenarioContent id="sales" step={3} onNext={onNext} onReset={onReset} />; }
  }
    ...
    if (step === 0) { return (
      <div className="flex h-full flex-col bg-slate-900 font-mono text-white">
        ...
        <div className="relative flex flex-1 flex-col items-center justify-center p-8">
          <div className="group relative flex h-64 w-64 cursor-pointer items-center justify-center rounded-3xl border-2 border-white/20 transition-colors hover:border-white/40" onClick={onNext}>
            ...
            <div className="text-center transition-transform duration-300 group-hover:scale-110">
              ...
              <span className="text-sm font-bold tracking-[0.2em] text-white/50">{t('tap_to_scan')}</span>
            </div>
            {/* Corner markers */}
        ...
        <div className="grid h-20 grid-cols-3 border-t border-slate-700 bg-slate-800">
          <div className="flex items-center justify-center border-r border-slate-700 bg-indigo-600 text-white"><Package className="h-7 w-7" /></div>
          <div className="flex items-center justify-center border-r border-slate-700 text-slate-400 hover:bg-slate-700/50"><RefreshCw className="h-7 w-7" /></div>
          <div className="flex items-center justify-center text-slate-400 hover:bg-slate-700/50"><Users className="h-7 w-7" /></div>
        </div>
      </div>
    ); }
    if (step === 1) { return (
      <div className="flex h-full flex-col bg-slate-900 p-6 font-mono text-white">
        <div className="mb-8 flex items-start gap-5">
          ...
          <div>
            ...
            <span className="rounded border border-green-500/30 bg-green-500/20 px-2.5 py-1.5 text-xs font-bold tracking-wide text-green-400 uppercase">{t('stock_valid')}</span>
          </div>
        </div>
        <div className="flex-1 space-y-4">
          <div className="rounded-2xl border border-slate-700 bg-slate-800 p-5">
            <label className="mb-1 block text-xs font-bold text-slate-500 uppercase">{t('current_stock')}</label>
          ...
          <div className="rounded-2xl border border-slate-700 bg-slate-800 p-5">
            <label className="mb-1 block text-xs font-bold text-slate-500 uppercase">{t('bin_location')}</label>
            <div className="text-2xl font-bold text-indigo-400">A-12-04</div>
          </div>
        </div>
        <Button fullWidth className="mt-auto h-14 bg-green-600 text-lg font-bold shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:bg-green-50" onClick={onNext}>{t('confirm_pick')}</Button>
      </div>
    ); }
    if (step === 2) { return <ScenarioContent id="sales" step={3} onNext={onNext} onReset={onReset} />; }
  }
