  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col gap-4">
        ...
        <div className="relative flex w-full flex-col justify-between overflow-hidden bg-slate-900 p-8 text-white">
          ...
          <div className="relative z-10">
            ...
            <Typography variant="h3" as="h3" className="font-bold text-white">
              {story.client}
            </Typography>
        ...
        <div className="flex flex-1 flex-col p-10 lg:p-14">
          <div className="mb-6">
            <Typography
              variant="h5"
