              ...
              >
                    ...
                    <Grid cols={2} gap={12} className="relative z-10 items-center">
                      <div>
                        <Typography variant="h3" as="h3" className="font-bold">
                          <AlertTriangle className="mr-2 inline h-6 w-6 text-amber-500" /> Why
                          Upgrade Now?
                        </Typography>
                        <Typography variant="body" className="leading-relaxed text-slate-400">
                          ...
                          Lihat daftar di samping untuk mengetahui apa yang menghambat Anda saat
                          ini.
                        </Typography>
                        <Link href="/tools/roi-calculator">
                          <Button
                ...
                <div className="mt-8 rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-center text-white shadow-xl lg:hidden">
                  ...
                  <Typography variant="small">
                    Lihat berapa banyak biaya yang bisa dihemat.
                  </Typography>
                  <Link href="/tools/roi-calculator">
                    <Button
                      size="md"
