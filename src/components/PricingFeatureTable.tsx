    ...
    <div className="mx-auto max-w-7xl">
      <div className="mb-12 text-center">
        <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl dark:text-white">
          {t('feature_table_heading')}
        </h2>
        <p className="text-lg text-slate-600 dark:text-slate-400">
          {t('feature_table_description')}
        </p>
      </div>
        ...
        <Card padding="none">
          <div className="grid grid-cols-4 gap-4 bg-slate-100 p-6 dark:bg-slate-800">
            <div className="font-bold text-slate-900 dark:text-white">
              {t('feature_table_col_feature')}
            </div>
            <div className="text-center">
              <div className="font-bold text-slate-900 dark:text-white">
                {t('feature_table_col_business')}
              </div>
            ...
            <div className="rounded-lg bg-blue-50 p-2 text-center dark:bg-blue-900/20">
              ...
              <div className="mt-2 inline-block rounded-full bg-blue-600 px-2 py-1 text-xs text-white">
                {t('feature_table_popular')}
              </div>
            </div>
            <div className="text-center">
              <div className="font-bold text-slate-900 dark:text-white">
                {t('feature_table_col_enterprise')}
              </div>
        ...
        <div className="flex flex-wrap items-center gap-6 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-700 dark:text-slate-300">
              {t('feature_table_legend_included')}
            </span>
          </div>
          <div className="flex items-center gap-2">
            <X className="h-5 w-5 text-slate-300" />
            <span className="text-slate-700 dark:text-slate-300">
              {t('feature_table_legend_not_available')}
            </span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-slate-500">-</span>
            <span className="text-slate-700 dark:text-slate-300">
              {t('feature_table_legend_custom')}
            </span>
          </div>
        </div>
      </Card>
