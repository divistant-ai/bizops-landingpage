    ...
    const validationErrors = validateFields([
      ...
      () =>
        validateNumber(monthlySales, {
          min: 0,
          required: false,
          fieldName: 'Estimasi Penjualan Bulanan',
        }),
    ]);
            ...
            <Card className="border-l-4 border-orange-500 bg-orange-50 p-4 dark:border-orange-600 dark:bg-slate-900">
              <div className="flex gap-2">
                ...
                <div className="text-xs text-slate-700 dark:text-slate-300">
                  <p className="mb-1 font-semibold dark:text-white">Apa itu Break Even Point?</p>
                  <p>
                    BEP adalah titik dimana total pendapatan sama dengan total biaya. Setelah
                    melewati BEP, bisnis mulai menghasilkan profit.
                  </p>
                </div>
              </div>
            </Card>
        ...
        <Card className="mt-8 border-l-4 border-orange-500 bg-orange-50 p-6 dark:border-orange-600 dark:bg-slate-900">
          <div className="flex gap-3">
            ...
            <div className="text-sm text-slate-700 dark:text-slate-300">
              <p className="mb-2 font-semibold dark:text-white">Tips Menggunakan BEP:</p>
              <ul className="list-inside list-disc space-y-1">
                <li>Semakin rendah BEP, semakin cepat bisnis menghasilkan profit</li>
                <li>
                  Tingkatkan contribution margin dengan menaikkan harga atau menurunkan biaya
                  variabel
                </li>
