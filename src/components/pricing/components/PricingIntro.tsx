    ...
    >
      ...
      >
        ...
        >
          ...
          {' '}
          <br />
          <span className="bg-linear-to-b from-slate-700 via-slate-600 to-slate-500 bg-clip-text text-transparent dark:from-white dark:via-slate-200 dark:to-slate-500">
