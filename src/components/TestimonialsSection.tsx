...
import { industryColors, testimonials, type Testimonial } from '@/data/testimonialsData';
...
function TestimonialCard({ testimonial }: TestimonialCardProps) {
  ...
  return (
    <div className="group relative w-[320px] sm:w-[380px] flex-shrink-0 mx-3">
      <div className="relative h-full rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 overflow-hidden transition-all duration-300 group-hover:-translate-y-1 group-hover:shadow-xl group-hover:border-primary-200 dark:group-hover:border-primary-700">
        {/* Gradient accent top */}
        ...
        <div className="p-6">
          ...
          <div className="relative mb-5">
            <Quote className="absolute -top-1 -left-1 h-6 w-6 text-slate-200 dark:text-slate-700 rotate-180" aria-hidden="true" />
            <blockquote className="pl-5">
              <p className="text-sm sm:text-base leading-relaxed text-slate-700 dark:text-slate-300 line-clamp-4">
                {testimonial.quote}
              </p>
            </blockquote>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4 pb-4 border-b border-slate-100 dark:border-slate-800">
            <div className="relative h-12 w-12 flex-shrink-0 rounded-full overflow-hidden ring-2 ring-white dark:ring-slate-800 shadow-md">
              <Image
          ...
          {/* Metrics - Compact */}
          <div className="flex items-center justify-between rounded-xl bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-800/50 p-3">
    ...
    >
      ...
      >
        <div className="max-w-2xl text-center md:text-left">
          ...
          <h2 className="text-2xl sm:text-3xl leading-tight font-bold tracking-tight text-slate-900 md:text-4xl dark:text-white">
            Dipercaya oleh{' '}
