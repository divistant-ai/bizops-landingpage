...
export const Sponsors = () => (
  <table className="border-collapse">
    <tbody>
      <tr className="h-56">
        <td className="border-2 border-slate-300 p-3 dark:border-slate-700">
          <a
        ...
        <td className="border-2 border-slate-300 p-3 dark:border-slate-700">
          <a
            href="https://www.coderabbit.ai?utm_source=bizops&utm_medium=website&utm_campaign=partners"
            target="_blank"
            rel="noopener"
          >
            <Image
      ...
      <tr className="h-56">
        <td className="border-2 border-slate-300 p-3 dark:border-slate-700">
          <a
            href="https://arcjet.com?utm_source=bizops&utm_medium=website&utm_campaign=partners"
            target="_blank"
            rel="noopener"
          >
        ...
        <td className="border-2 border-slate-300 p-3 dark:border-slate-700">
          <a
            href="https://sevalla.com?utm_source=bizops&utm_medium=website&utm_campaign=partners"
            target="_blank"
            rel="noopener"
          >
        ...
        <td className="border-2 border-slate-300 p-3 dark:border-slate-700">
          <a
            href="https://crowdin.com?utm_source=bizops&utm_medium=website&utm_campaign=partners"
            target="_blank"
            rel="noopener"
          >
