...
const PricingCalculator: React.FC = () => {
  ...
  const StepIndicator = () => (
    <div className="mx-auto mb-4 w-full max-w-2xl">
      ...
      <div className="absolute top-[0.6rem] right-0 left-0 -z-0 mx-auto hidden h-[1px] w-full max-w-2xl bg-slate-900 sm:block dark:bg-white" />
    </div>
  );
  ...
  const SummaryPanel = () => (
    <div className="flex h-full flex-col border-l border-slate-200 bg-slate-50 p-6 backdrop-blur-sm dark:border-white/5 dark:bg-white/5">
      ...
      <div className="mt-6 border-t border-slate-200 pt-6 dark:border-white/10">
        <div className="border-primary-200 from-primary-50 dark:border-primary-500/20 dark:from-primary-900/20 mb-4 rounded-xl border bg-gradient-to-br to-blue-50 p-4 dark:to-blue-900/20">
          ...
          <div className="mx-auto max-w-2xl">
            {assessmentStep === 1 && (
              <div className="space-y-6">
                  ...
                  {[
                    {
                      ...
                      desc: 'Fokus pada efisiensi & growth.',
                      icon: Rocket,
                    },
                    {
                      id: 'sme',
                      title: 'Medium (SME)',
                      desc: 'Butuh kontrol operasional ketat.',
                      icon: Building2,
                    },
                    {
                      id: 'enterprise',
                ...
                <div>
                  <label className="mb-3 block flex items-center gap-2 text-sm font-bold tracking-wider text-slate-700 uppercase dark:text-slate-400">
                    Industry Sector
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                    {[
                      ...
                      <div
                        ...
                        className={`flex cursor-pointer flex-col items-center gap-2 rounded-lg border p-2.5 transition-all duration-200 hover:scale-105 active:scale-95 ${assessment.industry === ind.id ? 'scale-105 border-2 border-slate-900 bg-slate-100 shadow-[0_0_0_3px_rgba(15,23,42,0.1)] dark:border-white dark:bg-slate-800 dark:shadow-[0_0_0_3px_rgba(255,255,255,0.1)]' : 'border-slate-300 bg-slate-50 hover:border-slate-400 hover:bg-slate-100 hover:shadow-md dark:border-slate-600 dark:bg-slate-800/50 dark:hover:border-slate-500 dark:hover:bg-slate-800'}`}
                      >
                        <ind.icon
                          className={`h-4 w-4 transition-all duration-200 ${assessment.industry === ind.id ? 'scale-110 text-slate-900 dark:text-white' : 'text-slate-600 group-hover:text-slate-900 dark:text-slate-400 dark:group-hover:text-white'}`}
                        />
                        <span
                          className={`text-xs font-semibold transition-colors ${assessment.industry === ind.id ? 'text-slate-900 dark:text-white' : 'text-slate-700 group-hover:text-slate-900 dark:text-slate-400 dark:group-hover:text-white'} text-center leading-tight`}
                        >
                          {ind.name}
                        </span>
                      </div>
              ...
              <div className="space-y-6">
                  ...
                  {[
                    {
                      id: 'cloud',
                      title: 'Shared Cloud',
                      desc: 'Hemat Biaya, Fully Managed.',
                      icon: Cloud,
                    },
                    {
                      id: 'dedicated',
                      title: 'Private VPS',
                      desc: 'High Performance & Security.',
                      icon: Server,
                    },
                    {
                      id: 'onprem',
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`flex flex-1 flex-col items-center gap-1 rounded-lg border py-3 text-xs font-bold transition-all active:scale-95 ${assessment.serverLocation === loc.id ? 'border-2 border-slate-900 bg-slate-100 text-slate-900 shadow-[0_0_0_3px_rgba(15,23,42,0.1)] dark:border-white dark:bg-slate-800 dark:text-white dark:shadow-[0_0_0_3px_rgba(255,255,255,0.1)]' : 'border-slate-300 bg-slate-50 text-slate-700 hover:border-slate-400 hover:bg-slate-100 hover:shadow-md dark:border-slate-600 dark:bg-slate-800/50 dark:text-slate-400 dark:hover:border-slate-500'}`}
                      >
                        <span>{loc.label}</span>
                        <span
                          className={`text-[9px] font-normal ${assessment.serverLocation === loc.id ? 'text-slate-800 dark:text-white/90' : 'text-slate-500 dark:text-slate-500'}`}
                        >
                          {loc.sub}
                        </span>
                      </button>
                ...
                <div
                  ...
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                      e.preventDefault();
                      updateAssessment('hasMultiCompany', !assessment.hasMultiCompany);
                    }
                  }}
                  role="button"
                  tabIndex={0}
                  aria-pressed={assessment.hasMultiCompany}
                  className={`flex cursor-pointer items-center justify-between rounded-xl border px-5 py-4 transition-all active:scale-98 ${assessment.hasMultiCompany ? 'border-2 border-slate-900 bg-slate-100 shadow-[0_0_0_3px_rgba(15,23,42,0.1)] dark:border-white dark:bg-slate-800 dark:shadow-[0_0_0_3px_rgba(255,255,255,0.1)]' : 'border-slate-300 bg-slate-50 hover:border-slate-400 hover:bg-slate-100 hover:shadow-md dark:border-slate-600 dark:bg-slate-800/50 dark:hover:border-slate-500 dark:hover:bg-slate-800'}`}
                >
                  <div className="flex items-center gap-3">
                    <Globe2
                      className={`h-5 w-5 transition-all ${assessment.hasMultiCompany ? 'scale-110 text-slate-900 dark:text-white' : 'text-slate-600 dark:text-slate-400'}`}
                    />
                    <div>
                      <div
                        className={`text-sm font-bold ${assessment.hasMultiCompany ? 'text-slate-900 dark:text-white' : 'text-slate-700 dark:text-slate-300'}`}
                      >
                        Multi-Entity Setup
                      </div>
                      <div className="text-[10px] text-slate-600 dark:text-slate-500">
                        Untuk perusahaan holding dengan banyak anak perusahaan (PT) dalam satu
                        sistem.
                      </div>
                    </div>
                  </div>
                  <div
                    className={`h-5 w-9 rounded-full p-0.5 transition-colors ${assessment.hasMultiCompany ? 'bg-slate-900 dark:bg-white' : 'bg-slate-300 dark:bg-slate-700'}`}
                  >
                    <div
                      className={`h-4 w-4 rounded-full bg-white shadow-sm transition-transform ${assessment.hasMultiCompany ? 'translate-x-4 dark:bg-slate-900' : ''}`}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                    ...
                    {[
                      {
                        key: 'needsCRM',
                        label: 'CRM & Sales',
                        desc: 'Leads, Pipeline, Quotation',
                        icon: UserCheck,
                      },
                      {
                        key: 'needsAccounting',
                        label: 'Finance',
                        desc: 'Jurnal, Neraca, Laba Rugi',
                        icon: Wallet,
                      },
                      {
                        key: 'needsInventory',
                        label: 'Inventory',
                        desc: 'Stock, Warehouse, Transfer',
                        icon: Package,
                      },
                      {
                        key: 'needsProcurement',
                        label: 'Procurement',
                        desc: 'PO, PR, Supplier Portal',
                        icon: ShoppingCart,
                      },
                      {
                        key: 'needsHRM',
                      ...
                      <div
                        ...
                        className={`flex min-h-[80px] cursor-pointer flex-col justify-center gap-1 rounded-xl border p-3 transition-all active:scale-95 ${assessment[m.key as keyof AssessmentData] ? 'border-2 border-slate-900 bg-slate-100 shadow-[0_0_0_3px_rgba(15,23,42,0.1)] dark:border-white dark:bg-slate-800 dark:shadow-[0_0_0_3px_rgba(255,255,255,0.1)]' : 'border-slate-300 bg-slate-50 hover:border-slate-400 hover:bg-slate-100 hover:shadow-md dark:border-slate-600 dark:bg-slate-800/50 dark:hover:border-slate-500 dark:hover:bg-slate-800'}`}
                      >
                        <div className="flex items-center gap-2">
                          <m.icon
                            className={`h-4 w-4 transition-all ${assessment[m.key as keyof AssessmentData] ? 'scale-110 text-slate-900 dark:text-white' : 'text-slate-600 dark:text-slate-400'}`}
                          />
                          <span
                            className={`text-sm font-medium ${assessment[m.key as keyof AssessmentData] ? 'text-slate-900 dark:text-white' : 'text-slate-700 dark:text-slate-400'}`}
                          >
                            {m.label}
                          </span>
                        </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                    {[
                      {
                        key: 'needsManufacturing',
                        label: 'Manufacturing',
                        desc: 'BOM, Work Order, Planning',
                        icon: Factory,
                      },
                      {
                        key: 'needsProjectMgmt',
                        label: 'Project Management',
                        desc: 'Task, Timesheet, Costing',
                        icon: Briefcase,
                      },
                      {
                        key: 'needsAssetMgmt',
                        label: 'Asset Management',
                        desc: 'Maintenance, Depreciation',
                        icon: BarChart3,
                      },
                      {
                        key: 'needsHelpdesk',
                        label: 'Helpdesk',
                        desc: 'Ticket, SLA, Customer Portal',
                        icon: Headphones,
                      },
                      {
                        key: 'needsPOS',
                        label: 'Point of Sales',
                        desc: 'Kasir Retail / F&B',
                        icon: Store,
                      },
                      {
                        key: 'needsEcommerce',
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-2">
                    {[
                      {
                        key: 'needsQualityControl',
                        label: 'Quality Control',
                        desc: 'Inspections & Goals',
                        icon: Activity,
                      },
                      {
                        key: 'needsFleet',
                      ...
                      },
                      {
                        ...
                        desc: 'Digital Archive & Versioning',
                        icon: FileCheck,
                      },
                      {
                        key: 'needsBI',
            ...
            {assessmentStep === 4 && (
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 dark:border-white/10 dark:bg-white/5">
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`flex flex-1 flex-col items-center gap-1 rounded-lg border py-3 text-xs font-bold transition-all active:scale-95 ${assessment.dataVolume === vol.id ? 'border-2 border-slate-900 bg-slate-900 text-white shadow-[0_0_0_3px_rgba(15,23,42,0.1)] dark:border-white dark:bg-white dark:text-slate-900 dark:shadow-[0_0_0_3px_rgba(255,255,255,0.1)]' : 'border-slate-300 bg-slate-50 text-slate-700 hover:border-slate-400 hover:bg-slate-100 hover:shadow-md dark:border-slate-600 dark:bg-slate-800/50 dark:text-slate-400 dark:hover:border-slate-500'}`}
                      >
                        <span>{vol.label}</span>
                        <span
                          className={`text-[9px] font-normal ${assessment.dataVolume === vol.id ? 'text-white/90 dark:text-slate-900/90' : 'text-slate-600 dark:text-slate-500'}`}
                        >
                          {vol.sub}
                        </span>
                      </button>
                  ...
                  >
                    <div className="flex cursor-pointer items-center gap-2">
                      <div
                        className={`flex h-4 w-4 items-center justify-center rounded border transition-all ${assessment.hasLegacySystem ? 'border-slate-900 bg-slate-900 dark:border-white dark:bg-white' : 'border-slate-400 dark:border-slate-500'}`}
                      >
                ...
                <div
                  ...
                  className={`flex cursor-pointer items-center justify-between rounded-2xl border p-5 transition-all active:scale-98 ${assessment.needsCustomModule ? 'border-2 border-slate-900 bg-slate-100 shadow-[0_0_0_3px_rgba(15,23,42,0.1)] dark:border-white dark:bg-slate-800 dark:shadow-[0_0_0_3px_rgba(255,255,255,0.1)]' : 'border-slate-300 bg-slate-50 hover:border-slate-400 hover:bg-slate-100 hover:shadow-md dark:border-slate-600 dark:bg-slate-800/50 dark:hover:border-slate-500 dark:hover:bg-slate-800'}`}
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`rounded-lg p-2 transition-all ${assessment.needsCustomModule ? 'scale-110 bg-slate-900 text-white dark:bg-white dark:text-slate-900' : 'bg-slate-200 text-slate-600 dark:bg-slate-800 dark:text-slate-400'}`}
                    >
                      <AppWindow className="h-5 w-5" />
                    </div>
                    <div>
                      <div
                        className={`text-sm font-bold ${assessment.needsCustomModule ? 'text-slate-900 dark:text-white' : 'text-slate-700 dark:text-slate-300'}`}
                      >
                        Develop Custom Module
                      </div>
                      <div className="text-[10px] text-slate-600 dark:text-slate-500">
                        Centang jika Anda memiliki alur bisnis unik yang tidak umum.
                      </div>
                    </div>
                  </div>
                  <div
                    className={`h-5 w-9 rounded-full p-0.5 transition-colors ${assessment.needsCustomModule ? 'bg-slate-900 dark:bg-white' : 'bg-slate-300 dark:bg-slate-700'}`}
                  >
                    <div
                      className={`h-4 w-4 rounded-full bg-white shadow-sm transition-transform ${assessment.needsCustomModule ? 'translate-x-4 dark:bg-slate-900' : ''}`}
                    />
                  </div>
                </div>
              </div>
                  ...
                  {[
                    {
                      ...
                      desc: '< 1 Month',
                      icon: Zap,
                      tooltip: 'Membutuhkan tim Fast-Track Deployment.',
                    },
                    {
                      id: '1month',
                      title: 'Standard',
                      desc: '1-2 Months',
                      icon: Clock,
                      tooltip: 'Timeline implementasi standar.',
                    },
                    {
                      id: '3months',
                      title: 'Planned',
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`flex flex-1 flex-col items-center gap-1 rounded-lg border py-3 text-xs font-bold transition-all active:scale-95 ${assessment.trainingPreference === tp.id ? 'border-2 border-slate-900 bg-slate-900 text-white shadow-[0_0_0_3px_rgba(15,23,42,0.1)] dark:border-white dark:bg-white dark:text-slate-900 dark:shadow-[0_0_0_3px_rgba(255,255,255,0.1)]' : 'border-slate-300 bg-slate-50 text-slate-700 hover:border-slate-400 hover:bg-slate-100 hover:shadow-md dark:border-slate-600 dark:bg-slate-800/50 dark:text-slate-400 dark:hover:border-slate-500'}`}
                      >
                        <span>{tp.label}</span>
                        <span
                          className={`text-[9px] font-normal ${assessment.trainingPreference === tp.id ? 'text-white/90 dark:text-slate-900/90' : 'text-slate-600 dark:text-slate-500'}`}
                        >
                          {tp.sub}
                        </span>
                      </button>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['standard', 'priority', 'premium'].map((lvl) => (
                      <button
                        ...
                        className={`rounded-xl border py-3 text-xs font-bold tracking-wider uppercase transition-all active:scale-95 ${assessment.supportLevel === lvl ? 'border-2 border-slate-900 bg-slate-900 text-white shadow-[0_0_0_3px_rgba(15,23,42,0.1)] dark:border-white dark:bg-white dark:text-slate-900 dark:shadow-[0_0_0_3px_rgba(255,255,255,0.1)]' : 'border-slate-300 bg-slate-50 text-slate-700 hover:border-slate-400 hover:bg-slate-100 hover:shadow-md dark:border-slate-600 dark:bg-slate-800/50 dark:text-slate-400 dark:hover:border-slate-500 dark:hover:text-white'}`}
                      >
                        {lvl}
                      </button>
                    ))}
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 transition-colors hover:bg-slate-100 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span
                          className={`font-medium ${assessment.hasMultiCompany ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-900 dark:text-white'}`}
                        >
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 transition-colors hover:bg-slate-100 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span
                          className={`font-medium ${assessment.needsCustomModule ? 'text-purple-600 dark:text-purple-400' : 'text-slate-900 dark:text-white'}`}
                        >
