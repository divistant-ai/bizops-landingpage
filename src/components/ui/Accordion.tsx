...
const Accordion: React.FC<AccordionProps> = ({ question, answer, className }) => {
  ...
  return (
    <div
      className={cn(
        'overflow-hidden rounded-2xl border border-slate-200 bg-white transition-all hover:border-purple-300 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-purple-700',
        className,
      )}
    >
      <button
