  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white transition-colors duration-300 dark:bg-slate-900">
      <div className="relative">
        {/* Outer Ring */}
        <div className="h-16 w-16 rounded-full border-4 border-slate-200 dark:border-slate-100"></div>
        {/* Spinning Ring */}
      ...
      <div className="mt-6 text-center">
        ...
        <p className="mt-1 animate-pulse text-xs tracking-widest text-slate-500 uppercase dark:text-white">
          Loading Environment
        </p>
      </div>
    </div>
