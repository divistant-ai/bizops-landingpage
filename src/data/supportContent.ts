...
export const sysReqData = {
  server: [
    {
      ...
      spec: 'Linux Ubuntu 22.04 LTS (Recommended), Debian 11, CentOS 8 Stream. (Windows Server not natively supported).',
      required: true,
    },
  ...
  client: [
    {
      item: 'Web Browser',
      spec: 'Google Chrome (Latest 3 versions), Mozilla Firefox, Safari, Microsoft Edge.',
      note: 'IE11 not supported',
    },
    {
      item: 'Mobile Android',
      spec: 'Android 10 (Q) or newer. Min 3GB RAM.',
      note: 'Camera min 8MP + Autofocus required for OCR',
    },
  ...
  network: [
    {
      port: '80/443',
      dir: 'Outbound',
      desc: 'Access to license.bizops.id and package repositories (github, pypi)',
    },
...
export const securityReportData = {
  scope: {
    in: {
      en: ['app.bizops.id (Core App)', 'api.bizops.id (API)', 'BizOps Mobile App (Android/iOS)'],
      id: ['app.bizops.id (Core App)', 'api.bizops.id (API)', 'BizOps Mobile App (Android/iOS)'],
    },
    out: {
      en: [
        'DDoS Attacks',
