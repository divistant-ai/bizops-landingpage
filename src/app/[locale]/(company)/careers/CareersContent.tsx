...
export default function CareersContent() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      {/* HERO SECTION */}
      <div className="relative overflow-hidden bg-white pt-32 pb-24 text-center lg:pt-48 lg:pb-32 dark:bg-[#0F172A] dark:text-white">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4">
          ...
          >
            BizOps adalah produk unggulan dari Divistant. Kami mencari engineer, desainer, dan
            pemikir kreatif yang ingin mendefinisikan ulang bagaimana perusahaan beroperasi di era
            digital.
          </motion.p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-slate-600 dark:text-slate-400">
              Di BizOps (Divistant), engineer bukan sekadar "tukang coding". Anda adalah arsitek
              solusi.
            </p>
          </div>
        ...
        <Container>
          <div className="mb-16 text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              Kami mengurus Anda, agar Anda bisa mengurus pekerjaan terbaik Anda.
            </p>
          </div>
      ...
      <Section className="bg-white dark:bg-gradient-to-br dark:from-indigo-900 dark:to-purple-900">
        <Container size="4xl" className="text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg font-light text-slate-600 dark:text-indigo-200">
            Bergabunglah dengan tim yang membangun infrastruktur digital untuk ribuan bisnis di
            Indonesia.
          </p>
