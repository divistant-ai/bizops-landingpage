        ...
        <Container size="7xl" className="relative z-10 text-center">
          ...
          >
            <Badge className="mb-8 border-slate-300 dark:border-white">
              <span className="text-slate-900 dark:text-white">Context-Aware ERP</span>
            </Badge>
          </motion.div>
          ...
          <h1 className="mb-8 text-4xl leading-tight font-extrabold tracking-tight text-slate-900 drop-shadow-sm md:text-6xl lg:text-7xl dark:text-white">
            <StaggeredText
              text="Stop Memaksa Bisnis Masuk ke"
          ...
          <FadeIn delay={0.3}>
            <p className="mx-auto mb-12 max-w-3xl text-lg leading-relaxed font-light text-slate-600 md:text-xl dark:text-slate-400">
              Software ritel tidak akan bertahan sehari di proyek konstruksi. Kebanyakan ERP
              memaksa Anda mengubah cara kerja demi keterbatasan sistem. BizOps berbeda—kami
              berbicara bahasa industri Anda sejak hari pertama.
            </p>
          </FadeIn>
          ...
          <FadeIn delay={0.5}>
            <Stack direction="vertical" gap={4} className="mb-0 justify-center sm:flex-row">
              ...
              >
                <span className="text-slate-900 dark:text-white">Lihat Demo Industri</span>
              </BouncyLink>
            </Stack>
          </FadeIn>
        </Container>
        ...
        <Container size="7xl">
          <FadeIn className="mx-auto mb-12 max-w-3xl text-center md:mb-20">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              Kami tidak percaya pada "Satu Ukuran untuk Semua". Lihat bagaimana BizOps
              menangani nuansa unik—dari perhitungan Kurva-S Konstruksi hingga manajemen
              expiry date Ritel.
            </p>
          </FadeIn>
          ...
          <FadeIn className="mx-auto mb-12 max-w-3xl text-center md:mb-20">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              Bukan hanya soal modul—ini soal perspektif. CEO butuh big picture, Finance
              butuh detail. Setiap role mendapat dashboard yang relevan dengan tanggung
              jawabnya.
            </p>
          </FadeIn>
      ...
      <Section className="relative overflow-hidden bg-slate-50 py-20 md:py-32 dark:bg-slate-900">
        ...
        <Container size="4xl" className="relative z-10 text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-xl text-slate-600 dark:text-slate-300">
            Coba full version dengan data perusahaan Anda sendiri. Gratis 14 hari, tanpa
            komitmen.
          </p>
          <Stack direction="vertical" gap={4} className="justify-center sm:flex-row">
            ...
            >
              <span className="text-white dark:text-slate-900">Mulai Trial Gratis</span>
            </BouncyLink>
            <BouncyLink
            ...
            >
              <span className="text-slate-900 dark:text-white">Cek Estimasi Harga</span>
            </BouncyLink>
          </Stack>
