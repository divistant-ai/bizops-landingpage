...
export function TrustHeroAnimated() {
  return (
    <>
      ...
      >
        Kami membangun BizOps dengan filosofi &quot;Security by Design&quot;. Transparansi
        penuh mengenai infrastruktur, enkripsi, dan kepatuhan regulasi kami ada di sini.
      </motion.p>
      ...
      >
        ...
        <Link href="/security/report">
          <Button
            size="lg"
            variant="outline"
            className="w-full border-slate-700 text-white hover:bg-white/10 sm:w-auto"
          >
