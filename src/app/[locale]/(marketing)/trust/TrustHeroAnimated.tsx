...
export function TrustHeroAnimated() {
  return (
    <>
      ...
      >
        <Shield className="h-3 w-3" /> BizOps Trust Center
      </motion.div>
      ...
      >
        ...
        >
          Download Security Whitepaper <Download className="ml-2 h-4 w-4" />
        </Button>
        <Link href="/security/report">
          ...
          >
            Laporkan Celah Keamanan <AlertTriangle className="ml-2 h-4 w-4" />
          </Button>
        </Link>
      </motion.div>
    </>
