...
const consultantTools = [
  {
    ...
    description:
      'Temukan solusi ERP yang tepat dengan analisis kebutuhan komprehensif 7-step.',
    icon: Search,
  ...
  },
  {
    ...
    description:
      'Hitung biaya tersembunyi yang perusahaan keluarkan akibat turnover karyawan.',
    icon: Users,
  ...
  },
  {
    ...
    description:
      'Bandingkan BizOps dengan Excel, Odoo, SAP, dan sistem lainnya secara teknis.',
    icon: GitCompare,
    href: '/comparisons',
    color: 'blue',
    badge: null,
  ...
  },
  {
    ...
    description:
      'Panduan lengkap migrasi data dari Excel, Software Akuntansi, atau Legacy ERP.',
    icon: Rocket,
    href: '/migration',
    color: 'emerald',
    badge: null,
        ...
        <Container>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-xl leading-relaxed text-slate-600 dark:text-slate-400">
              Dari kalkulator pajak hingga strategic planning tools. Semuanya dirancang
          ...
          <div className="from-primary-50 dark:from-primary-900/20 mt-20 rounded-3xl border border-slate-200 bg-gradient-to-br to-purple-50 p-8 md:p-12 dark:border-neutral-800 dark:border-slate-800 dark:to-purple-900/20">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mb-8 text-lg text-slate-600 dark:text-slate-400">
                Tools ini gratis dan powerful, tapi untuk otomasi penuh dan integrasi
                sistem, Anda butuh platform BizOps. Coba gratis 14 hari, no credit card
                required.
              </p>
