        ...
        <Container className="px-4 md:px-6 lg:px-8" size="7xl">
          <Grid cols={2} gap={12} className="items-center lg:gap-20">
            ...
            <div className="relative z-10 flex flex-col items-start text-left">
              ...
              <Typography variant="body" className="mb-10 max-w-xl text-lg leading-relaxed text-slate-600 lg:text-xl dark:text-slate-400">
                {t('hero_subtitle')}
              </Typography>
              ...
              <Stack direction="vertical" gap={4} className="mb-12 w-full sm:w-auto">
                ...
                >
                  ...
                  <div className="relative z-10 text-left leading-none">
                    <div className="mb-1.5 text-[11px] font-medium tracking-wide uppercase opacity-80">{t('get_it_on')}</div>
              ...
              <div className="flex items-center gap-8">
                ...
                <div>
                  ...
                  <Typography variant="body" className="text-sm font-medium text-slate-500 dark:text-slate-400">
                    {t('reviews_text')}
                  </Typography>
                </div>
              </div>
                  ...
                  <div className="relative h-[680px] overflow-hidden rounded-[3rem] bg-white dark:bg-slate-950">
                    ...
                    <div className="relative z-10 border-b border-slate-200 bg-slate-50 px-6 pt-12 pb-6 backdrop-blur-md dark:border-white/5 dark:bg-slate-900/50">
                      <div className="mb-6 flex items-center justify-between">
                        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-linear-to-tr from-blue-500 to-indigo-600 text-sm font-bold text-white shadow-lg shadow-blue-500/30">BS</div>
                    ...
                    {/* App Body */}
                    <Stack direction="vertical" gap={4} className="relative z-20 h-full overflow-y-auto p-5 pb-20">
                      {/* Stats Card */}
                      <div className="rounded-3xl border border-slate-100 bg-white p-5 shadow-lg shadow-slate-200/50 dark:border-slate-800 dark:bg-slate-900/80 dark:shadow-none">
                        <div className="mb-4 flex items-center justify-between">
                          <Typography variant="h3" as="h3" className="text-base font-bold text-slate-900 dark:text-white">
                            {t('todays_approval')}
                          </Typography>
                      ...
                      <Grid cols={2} gap={3}>
                        {[
                          { icon: Layers, label: t('stock'), color: 'bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400' },
                          { icon: Zap, label: t('sales'), color: 'bg-amber-50 text-amber-600 dark:bg-amber-900/20 dark:text-amber-400' },
                          {
                            icon: FileCode,
                            label: t('report'),
      ...
      <Section className="relative z-10 border-t border-slate-200/50 bg-white/50 py-24 backdrop-blur-xl dark:border-white/5 dark:bg-slate-900/50">
        <Container className="px-4 md:px-6 lg:px-8" size="7xl">
          <div className="mx-auto mb-20 max-w-3xl text-center">
            <Typography variant="h2" as="h2" className="mb-4 text-3xl font-extrabold text-slate-900 md:text-4xl dark:text-white">
              {t('features_title')}
            </Typography>
            <Typography variant="body" className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
              {t('features_subtitle')}
            </Typography>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              <div key={i} className="group relative h-full overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-200/50 dark:border-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800 dark:hover:shadow-none">
                ...
                <Typography variant="h3" as="h3" className="mb-3 text-xl font-bold text-slate-900 dark:text-white">
                  {feature.title}
                </Typography>
                <Typography variant="small" className="text-base leading-relaxed text-slate-600 dark:text-slate-400">
                  {feature.desc}
                </Typography>
              </div>
            ))}
