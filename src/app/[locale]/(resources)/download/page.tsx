            ...
            <div className="relative z-10">
              ...
              <Stack direction="vertical" gap={4} className="mb-10">
                ...
                <Link
                  ...
                  target="_blank"
                  className="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-100 px-6 py-3.5 text-slate-900 transition-colors hover:bg-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700"
                >
                    ...
                    <Stack direction="vertical" gap={4} className="relative z-20 -mt-6 p-4">
                      ...
                      <Grid cols={2} gap={4}>
                        {[
                          ...
                          <div
                            key={i}
                            className="flex aspect-square flex-col items-center justify-center gap-2 rounded-2xl bg-slate-50 p-4 transition-colors hover:bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-800"
                          >
                            <div
