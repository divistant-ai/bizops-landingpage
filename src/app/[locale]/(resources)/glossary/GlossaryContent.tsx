      ...
      <Container className="px-4 md:px-6 lg:px-8" size="7xl">
        ...
        <Container noPadding size="3xl" className="mb-16 text-center">
          <Stack
            ...
            align="center"
            justify="center"
            className="bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 mb-6 rounded-xl p-3"
          >
        ...
        <Grid cols={2} gap={8} className="mb-16">
          {filteredData.map((item, idx) => (
            <div
              key={idx}
              className="hover:border-primary-100 dark:hover:border-primary-900 group rounded-2xl border border-slate-100 bg-slate-50 p-8 transition-all hover:bg-white hover:shadow-lg dark:border-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800"
            >
              <Stack direction="horizontal" gap={4} align="center" className="mb-4">
                <Stack
                  ...
                  align="center"
                  justify="center"
                  className="text-primary-600 dark:text-primary-400 group-hover:bg-primary-600 h-12 w-12 rounded-lg border border-slate-200 bg-white text-2xl font-bold shadow-sm transition-colors group-hover:text-white dark:border-slate-700 dark:bg-slate-800"
                >
                  {item.char}
                </Stack>
                <Typography
              ...
              <Stack direction="vertical" gap={4}>
                <div>
                  <Typography variant="small" className="text-slate-400 dark:text-slate-500">
                    {t('definition_label')}
                  </Typography>
                  <Typography
                    variant="small"
                    className="mt-1 block leading-relaxed text-slate-700 dark:text-slate-300"
                  >
                    {item.def}
                  </Typography>
                </div>
                <div className="border-t border-slate-200 pt-4 dark:border-slate-800">
                  <Typography variant="small" className="text-slate-400 dark:text-slate-500">
                    {t('why_it_matters_label')}
                  </Typography>
                  <Typography
                    variant="small"
                    className="mt-1 block leading-relaxed text-slate-600 dark:text-slate-400"
                  >
                    &ldquo;
                    {item.context}
                    &rdquo;
        ...
        <div className="relative overflow-hidden rounded-2xl bg-slate-900 p-8 text-center text-white md:p-12">
          <Container noPadding size="4xl" className="relative z-10">
            ...
            <Link href="/demo">
              <Button
                size="md"
                className="mt-6 border-none bg-white text-slate-900 hover:bg-slate-200"
              >
                {t('cta_button')}
                {' '}
