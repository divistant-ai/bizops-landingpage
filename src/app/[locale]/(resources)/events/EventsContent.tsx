...
export default function EventsContent() {
  ...
  const categoryKeys = [
    ...
    { value: 'Live Demo', key: 'filter_live_demo' },
    { value: 'Webinar', key: 'filter_webinar' },
    { value: 'Masterclass', key: 'filter_masterclass' },
  ] as const;
      ...
      <div className="dark:bg-dark-bg relative overflow-hidden bg-slate-50 pt-32 pb-24 lg:pt-32 lg:pb-48 dark:text-white">
        ...
        <Container size="7xl" className="relative z-10 text-center">
          ...
          <motion.div
            ...
            className="mx-auto flex max-w-2xl flex-col items-center gap-2 rounded-2xl border border-slate-300 bg-white p-2 shadow-2xl sm:flex-row dark:border-white/10 dark:bg-white/5"
          >
